angular.module('hiveInTown.serviceprovider').service("serviceproviderService", function($http, $q) {
	
	var CREATE_USER_URL_PATH = "/server/HTServer/updateResidentDetail";
	var UPLOAD_URL_PATH = '/server/file/upload/';
	var COMMUNITY_URL_BASE = "/server/community/"
	...
	var SEND_LINK_URL_PATH = "/server/HTServer/sendinvites/{urlKeyword}";
	var REMOVE_USER_URL_PATH = "/server/HTServer/removeuser/{urlKeyword}/{id}";
	...
	this.getMembers = function(urlKeyword) {
		var url = COMMUNITY_URL_BASE + urlKeyword + LIST_RESIDENTS_URL_PATH;
		return $http.get(url);
