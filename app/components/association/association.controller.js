...
angular.module('hiveInTown.association').controller("associationController", function($scope, $state, $stateParams, 
	...
	$scope.tabs = [{title : 'Meeting', disabled: false},
	               {title : 'People', disabled: false}]
